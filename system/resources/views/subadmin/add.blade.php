...
<div class="section users-edit">
  <div class="card">
    <div class="card-content">
      <h5>{{ __('locale.Add Sub Admin') }} </h5>

      <div class="divider mb-3"></div>
      <div class="row">
        <div class="col s12" id="account">
     
          <form id="accountForm" action="{{ url('add-sub-admin') }}" enctype='multipart/form-data' method="post">
            @csrf
            <div class="row">
              <div class="col s12 m6">
                <div class="row">
                  ...
                  <div class="col s12 input-field">
                    <input id="Username" name="username" value="{{ old('username') }}"  type="text"  required>
              ...
              <div class="col s12 m6">
                <div class="row">
                  <div class="col s12 input-field">
                    ...
                    <input id="Lastname" name="lastname" value="{{ old('lastname') }}" pattern="[a-zA-Z]*" type="text"  required>
