...
{{-- page content --}}
@section('content')
<div id="forgot-password" class="row" style="position: relative;
    height: 10em;
    display: flex;
    align-items: center;
    justify-content: center;">
    <div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8" style="position: absolute;
    top: 50%;margin: 0;">
    {{-- success status --}}
    @if (session('status'))
