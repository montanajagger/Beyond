<div class="navbar @if(($configData['isNavbarFixed'])=== true){{'navbar-fixed'}} @endif">
  <nav
    ...
    <div class="nav-wrapper">
       ...
       {{--  <i class="material-icons">search</i>
        ...
        <p style="line-height: 1 !important;">Error : {{ Session::get('error') }} </p>
        </div>
        ...
        <div class="card-content white-text">
        <p style="line-height: 1 !important;">Success : {{ Session::get('success') }} </p>
        </div>
        <button type="button" class="close white-text" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">×</span>
        </button>
        ...
        <div class="card-alert card red m-0">
        <div class="card-content white-text">
        <p style="line-height: 1 !important;">Error : 
 ...
 {{--        <li class="hide-on-med-and-down">
     ...
     {{--    <li>
        ...
        <li>
          <a class="grey-text text-darken-1" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('frm-logout').submit();">
