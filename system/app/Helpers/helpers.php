...
class Helper
{
    public static function applClasses()
    {
        ...
        $allOptions = [
            ...
            'defaultLanguage'=>array('en'=>'en','fr'=>'fr','de'=>'de','pt'=>'pt','ar'=>'ar'),
    ...
    public static function check_permissions($group_id, $permission_id){
        
       $check = \App\GroupPermissions::where(['group_id' => $group_id, 'permission_id' => $permission_id])->first();
    ...
    public static function get_settings_data($key){
        $settings = \DB::table('settings')->where('key_name',$key)->first();
        if(!is_null($settings)){
          return $settings;
        }else{
          return null;
    ...
    public static function terms($key){
        $page_terms_conditions = \DB::table('page_terms_conditions')->where('key_name',$key)->first();
        if(!is_null($page_terms_conditions)){
          return $page_terms_conditions;
        }else{
          return null;
        }  
    }
    
    public static function get_package_duration($id){
     
        $duration = \DB::table('package_durations')->where('id',$id)->first();
         if(!is_null($duration)){
            echo $duration->title;
         }else{
            echo "-";
    ...
    public static function get_work_name($id){
        $work = \DB::table('tbl_work')->where('id',$id)->first();
         if(!is_null($work)){
            echo $work->name;
         }else{
            echo "-";
    ...
    public static function get_city_name($id){
        $cities = \DB::table('tbl_cities')->where('id',$id)->first();
         if(!is_null($cities)){
            echo $cities->name;
         }else{
            echo "-";
